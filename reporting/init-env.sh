...
echo "Setting TRUSTED_HOSTNAME, OL_BASE_URL, AUTH_SERVER_CLIENT_ID, AUTH_SERVER_CLIENT_SECRET, OL_SUPERSET_PASSWORD, SRC_POSTGRES_USER, SRC_POSTGRES_PASSWORD, OL_SUPERSET_USER, OL_SUPERSET_PASSWORD"
