...
- `Static Documentation for Reference Data API <http://build.openlmis.org/job/OpenLMIS-referencedata-pipeline/job/master/1114/artifact/build/resources/main/api-definition.html>`_
...
- `Javascript Documentation <http://build.openlmis.org/job/OpenLMIS-reference-ui-pipeline/job/master/2358/artifact/build/docs/index.html#/api>`_
...
- `Static Documentation for Stock Management API <http://build.openlmis.org/job/OpenLMIS-stockmanagement-pipeline/job/master/665/artifact/build/resources/main/api-definition.html>`_
