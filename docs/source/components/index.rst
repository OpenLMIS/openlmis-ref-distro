...
- `Static Documentation for Fulfillment API <http://build.openlmis.org/job/OpenLMIS-fulfillment-pipeline/job/rel-3.0.3/lastSuccessfulBuild/artifact/build/resources/main/api-definition.html>`_
...
- `Static Documentation for Reference Data API <http://build.openlmis.org/job/OpenLMIS-referencedata-pipeline/job/rel-6.0.1/lastSuccessfulBuild/artifact/build/resources/main/api-definition.html>`_
...
- `UI Styleguide <http://build.openlmis.org/job/OpenLMIS-reference-ui-pipeline/job/rel-5.0.1/lastSuccessfulBuild/artifact/build/styleguide/index.html#!/login>`_
- `Javascript Documentation <http://build.openlmis.org/job/OpenLMIS-reference-ui-pipeline/job/rel-5.0.1/lastSuccessfulBuild/artifact/build/docs/index.html#/api>`_
...
- `Static Documentation for Requisition API <http://build.openlmis.org/job/OpenLMIS-requisition-pipeline/job/rel-3.1.4/lastSuccessfulBuild/artifact/build/resources/main/api-definition.html>`_
