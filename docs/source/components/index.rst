...
- `Static Documentation for Auth API <http://build.openlmis.org/job/OpenLMIS-auth-pipeline/job/rel-3.2.0/lastSuccessfulBuild/artifact/build/resources/main/api-definition.html>`_
...
- `Static Documentation for Fulfillment API <http://build.openlmis.org/job/OpenLMIS-fulfillment-pipeline/job/rel-7.0.0/lastSuccessfulBuild/artifact/build/resources/main/api-definition.html>`_
...
- `Static Documentation for CCE API <http://build.openlmis.org/job/OpenLMIS-cce-pipeline/job/rel-1.0.0/lastSuccessfulBuild/artifact/build/resources/main/api-definition.html>`_
...
- `Static Documentation for Notification API <http://build.openlmis.org/job/OpenLMIS-notification-pipeline/job/rel-3.0.5/lastSuccessfulBuild/artifact/build/resources/main/api-definition.html>`_
...
- `Static Documentation for Reference Data API <http://build.openlmis.org/job/OpenLMIS-referencedata-pipeline/job/rel-10.0.0/lastSuccessfulBuild/artifact/build/resources/main/api-definition.html>`_
...
- `UI Styleguide <http://build.openlmis.org/job/OpenLMIS-ui-components-pipeline/job/rel-5.3.0/lastSuccessfulBuild/artifact/build/styleguide/index.html>`_
...
- `Javascript Documentation <http://build.openlmis.org/job/OpenLMIS-reference-ui-pipeline/job/rel-5.0.6/lastSuccessfulBuild/artifact/build/docs/index.html#/api>`_
...
- `Static Documentation for Report API <http://build.openlmis.org/job/OpenLMIS-report-pipeline/job/rel-1.4.0/lastSuccessfulBuild/artifact/build/resources/main/api-definition.html>`_
...
- `Static Documentation for Requisition API <http://build.openlmis.org/job/OpenLMIS-requisition-pipeline/job/rel-6.0.0/lastSuccessfulBuild/artifact/build/resources/main/api-definition.html>`_
...
- `Static Documentation for Stock Management API <http://build.openlmis.org/job/OpenLMIS-stockmanagement-pipeline/job/rel-3.0.0/lastSuccessfulBuild/artifact/build/resources/main/api-definition.html>`_
